"""
1. **Инициализация эксперимента в CometML** (онлайн/оффлайн режим).
2. **Логирование метрик, изображений, аудиофайлов, текстов и таблиц**.
3. **Автоматическое сохранение чекпоинтов (моделей) в CometML**.
4. **Слежение за скоростью обучения (steps/sec)**.
"""
