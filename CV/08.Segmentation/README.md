...
Отличный проект! У вас уже есть вся необходимая информация, её просто нужно красиво и логично упаковать. README — это лицо проекта, и хороший README значительно повышает его ценность.

Вот полностью переработанная версия вашего `README.md`. Я постарался сохранить всю вашу информацию, но представил её в более структурированном и профессиональном виде, добавив разделы, которые обычно присутствуют в серьезных проектах.
...
Основная задача — разработка и обучение сверточной нейронной сети (CNN) для точного предсказания масок зданий на основе спутниковых изображений.
...
- [ ] Реализовать скрипт `scripts/pred_image.py` для удобного локального инференса.
- [ ] Настроить **Airflow** для оркестрации пайплайнов (например, периодическое переобучение модели).
...
- [ ] [[разобраться в docker-compose c пунктом version]]
...
- [ ] airflow - понять чо к чему и для чего)
- [ ] Расширить кол-во метрик и сделать более продвинутый мониторинг
- [ ] Написать четкий ReadMe
- [ ] Окончательно проверить весь проект, разместить на GitHub
